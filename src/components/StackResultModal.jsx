  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <div className="relative bg-gradient-to-r from-cs-green/20 to-cs-purple/20 px-6 py-5 text-center">
            <button type="button" onClick={onClose} className="absolute right-4 top-4 text-gray-500 hover:text-white">
              <X size={18} />
            </button>
            <CheckCircle size={48} className="mx-auto mb-2 text-cs-green" />
